$(function(){
  ...
  $(".link_grafico").on('click', function(e){
    ...
    if($('div#graficos_generados').find('#'+$(this).data('grafico')).length == 0)
    {
      ...
      variable = {id:partes[1], descripcion:variables[partes[1]], unidad:unidades[partes[1]], fuente: 'Fuente: '+fuentes[partes[1]]};
      serie = [];
      if(partes[0] == 'region'){
  ...
  $(".link_grafico_comparativo").on('click', function(e){
    ...
    if($('div#graficos_generados').find('#'+$(this).data('grafico')).length == 0)
    {
      ...
      var item = {id: partes[1], descripcion:frecuencias[partes[1]], unidad:"", fuente:""};
