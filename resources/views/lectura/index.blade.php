			...
			<div class="col-md-12">
				...
				{!! Form::open(array('action' => ['LecturaController@index'], 'method' => 'GET')) !!}
					<p>
						...
						@if($fechas != null)
							<a href="{{action('LecturaController@index')}}" class="btn btn-default btn-sm" data-toggle="tooltip" data-position="top" title="Limpiar b&uacute;squeda"><span class="icon-cancel-alt-filled"></span></a>
						@endif
					</p>
				{!! Form::close() !!}
				</div>
