      ...
      <div class="table-responsive">
        ...
        <thead>
          <tr class="azul_FCE_bg blanco">
            ...
            <th class="text-right"><span title="FUENTE: {{$info_pivot['fuentes'][$id_ind]}} ( en {{$info_pivot['unidades'][$id_ind]}} )" data-toggle="tooltip" data-placement="top">{{$indicador}}</span></th>
            @endforeach
        ...
        <tfoot>
            <tr class="gris_table_bg">
                ...
                @foreach($info_pivot['indicadores'] as $id_ind => $indicador)
                <td class="text-right"><strong>{{isset($data_pivot_inversa[$id_ind][$id_aniofrec]) ? array_sum($data_pivot_inversa[$id_ind][$id_aniofrec]) : '-'}}</strong></td>
                @endforeach
      ...
      <div class="row">
          ...
          <div class="col-md-6">
            <h4>
              ...
              <a href="#" title="Grafico de linea" class="link_grafico_frecuencia" data-grafico="frecindicador_{{$id_aniofrec}}_linea">
                <span class="icon-chart-line"></span>
              </a>
              <a href="#" title="Grafico de radar" class="link_grafico_frecuencia" data-grafico="frecindicador_{{$id_aniofrec}}_radar">
                <span class="icon-chart-pie-outline"></span>
              </a>
              <a href="#" title="Grafico de columnas" class="link_grafico_frecuencia" data-grafico="frecindicador_{{$id_aniofrec}}_columna">
                <span class="icon-chart-bar-1"></span>
              </a>
              <a href="#" title="Grafico de puntos" class="link_grafico_frecuencia" data-grafico="frecindicador_{{$id_aniofrec}}_puntos">
                <span class="icon-chart-alt-outline"></span>
              </a>
            </h4>
          </div>
...
<script>
var datos_anio_region_indicador = <?php echo json_encode($anio_region) ?>;
</script>