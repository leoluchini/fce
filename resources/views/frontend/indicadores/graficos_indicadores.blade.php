<!-- Modal -->
<div class="modal fade" id="modal_indicadores" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
<script>
var indicadores = <?php echo json_encode($info_pivot['indicadores']) ?>;
